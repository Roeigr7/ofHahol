    ...
    return (
      <div className='App'>
        ...
        <p>
          ...
          <br />
          <br />
          הספר עוף החול מבוסס על סיפור אמיתי ועל חיי. זו לא עלילת פרי הדמיון או
          פנטזיה, אלא תסריט חיי שמלווה אותי מהנקודות הקשות ביותר ועד למקום של
          שיא ההצלחה.
          <br />
          הספר כתוב כעלילה מעניינת שתרתק אתכם ותשאיר אתכם פעורי פה, ואם לרגע היה
          לכם ספק עד כמה המצב היה קשה ועד כמה השינוי היה אמיתי - "עוף החול" יענה
          לכם על כל השאלות.
          <br />
          זה לא סתם עוד ספר, זה ספר משנה פרספקטיבה וחיים - שינער אתכם ויגרום לכם
          להבין שגם אתם יכולים.
          <br />
        </p>
        ...
        <p>
          ...
          אחרי חובות עתק שהשארתי בארץ - אשר לשמחתי, הצלחתי לסלק אחרי 5 שנים של
          עבודה קשה.
          <br />
          מספר חודשים לאחר חזרתי הקמתי חברה בפורמט שונה מעט מבעבר, אשר הכניסה
          אותי למערבולת <strong>מסחררת</strong> שבה איבדתי את כל החסכונות איתם
          הגעתי ואף יצרתי חובות במספרים <strong>כפולים</strong> מהפעם הקודמת.{' '}
          <br />
          <br />
          רק שהפעם מלבד חובותיי לבנקים, היו גם חובות לשוק האפור...
          <br />
          <br />
          אם לא די בזאת, <strong>בנקודת השיא</strong> של נפילתי הכלכלית איבדתי
          את אימי האהובה ממחלת הסרטן ואילו בני סיקירי, אובחן על הספקטרום
          האוטיסטי. <br />
          למרות כל המשברים, ולמרות חובות עצומים שצברתי, התרחשו ניסים גלויים
          שהביאו אותי לנקודה בה אני נמצא היום -{' '}
          <strong>נקי מכל חוב, בעל אמצעים ומשפחה אוהבת ותומכת</strong>.<br />
          אם לכתוב ספר היה בגדר "חלום" - אז אצלי אין חלומות, רק יעדים. <br />
        ...
        <div className='self-introduction'>
          <div className='text'>
            ...
            <p>
              ...
              <br />
              נשוי ואב ל-4 ילדים מדהימים ואיש עסקים בעל חברות בארץ ובעולם בתחומי
              השיווק, המרקטינג, הנדל"ן והייעוץ עסקי.
              <br />
              <br />
        ...
        <p>
          ...
          <br />
          <br />
          איך אומרים? לזהות את הבעיה הוא שלב חשוב וגדול במציאת הפתרון לה. אז כאן
          אני לא בטוח שימצא פתרון.
          <br />
          <br />
          שלא תבינו אותי לא נכון, אני לא מהמר בקטע של קזינו, או טוטולוטו. אני
          מהמר על הכול בחיים ורוב ההימורים האלה הם בכלל עם עצמי, וללא קשר לגורם
          חיצוני כלשהו.
          <br />
          <br />
          "בוא נראה אם אני מצליח להוריד את המחיר של הדירה ל 400 אלף" "בוא נראה
          אם אני מוציא מהמשקיע הזה עוד מאה אלף דולר" או "הנה חנות שכבר שניים
          נפלו בה. בוא נראה אם אני אצליח להרים אותה לשחקים".
          <br />
          <br />
          אלה שלוש דוגמאות להימורים שלי עם עצמי, ואלה דוגמאות טריות, שהתרחשו
          בחצי השנה האחרונה. אבל ההימורים הם אצלי בדם, כבר מילדות ומספר הדוגמאות
          בטח יגיע למאות. בכל תחומי החיים. הימרתי בעסקים והימרתי בגדול, בניהול
          משאים ומתנים מול אנשים וארגונים חזקים ממני בהרבה, וכשאני החזקתי דקות
          ארוכות מבלי למצמץ, הם נשברו ואני "זכיתי" בהימור. כך קיבלתי עבודה למרות
          שנהריה לא בדיוק ממוקמת באיזור המרכז, כך קיבלתי שכר משודרג מכרישי עסקים
          ממולחים שלא האמינו למספרים שאני זורק לאוויר, וכך הצלחתי בגיל 38 לצאת
          ל"פנסיה".
          <br />
          <br />
          אם אתה מהמר על הסוס הנכון, אתה תזכה בהימור. והסוס המנצח הזה היה "אני"
          ואני האמנתי בו כמעט תמיד. וכשהפסקתי להאמין בו לעיתים, כשהנמוך היה נמוך
          מאוד, נמוך מידי עבורי, הייתה לי משפחה אוהבת שתמכה בי, הצילה אותי
          והימרה עלי."
          <br />
          <br />
        </p>
        ...
        <ul className='bad-list'>
          ...
          <li>
            <span>לאנשים שחושבים שהם במקום הכי גבוה שהם מסוגלים להיות בו</span>
          </li>
          <li>
        ...
        <ul className='good-list'>
          ...
          <li>
            <span>
              אם אתם נמצאים בחובות ורוצים לקבל השראה ממישהו שעבר בדיוק אותו דבר
            </span>
          </li>
          <li>
          ...
          <li>
            <span>
              אם אתם רוצים לשנות את החשיבה ולהצליח לקום מהמקומות הנמוכים בחיים
            </span>
          </li>
          <li>
        ...
        <p>
          ...
          <strong>חופשיים</strong> <strong>כלכלית</strong> ובעיקר - אושר וזמן
          חופשי להיות עם היקרים לכם מכל.
        </p>
        <Button
        ...
        <Button
          variant='contained'
          classes={{ root: `question ${this.state.qna[0] ? 'opened' : ''}` }}
          onClick={() => this.qna(0)}
        >
        ...
        <Collapse in={this.state.qna[0]}>
          <h2>
            הספר מתאים לכל אחד שמרגיש הוא רוצה יותר, והוא מוכן להשקיע זמן לקריאה
            בשביל זה.
          </h2>
        </Collapse>
        <Button
          variant='contained'
          classes={{ root: `question ${this.state.qna[1] ? 'opened' : ''}` }}
          onClick={() => this.qna(1)}
        >
        ...
        <Collapse in={this.state.qna[1]}>
          <h2>
            מובן ולגיטימי לגמרי, אבל התשלום מאובטח באבטחה המקסימלית. אני עובד עם
            מערכת סליקה שנקראת X והכל נשאר חסוי.
            <br />
        ...
        <Button
          variant='contained'
          classes={{ root: `question ${this.state.qna[2] ? 'opened' : ''}` }}
          onClick={() => this.qna(2)}
        >
          כמה עמודים ופרקים יש בספר?
        </Button>
        <Collapse in={this.state.qna[2]}>
          <h2>X עמודים שמתוכם Y פרקים שישאירו אתכם פעורי פה ומלאי השראה.</h2>
        </Collapse>
        <Button
          variant='contained'
          classes={{ root: `question ${this.state.qna[3] ? 'opened' : ''}` }}
          onClick={() => this.qna(3)}
        >
          האם זה ספר דיגיטלי או פיזי?
        </Button>
        <Collapse in={this.state.qna[3]}>
          <h2>יש אופציה לקנות את הספר גם בגרסא פיזית וגם בגרסא הדיגיטלית</h2>
        </Collapse>
        <Button
          variant='contained'
          classes={{ root: `question ${this.state.qna[4] ? 'opened' : ''}` }}
          onClick={() => this.qna(4)}
        >
          השתכנעתי, איך אני רוכש את הספר?
        </Button>
        <Collapse in={this.state.qna[4]}>
          <h2>כאן בדף הרכישה, או בהעברה בנקאית או באופציה אחרת (לבחירתך שי)</h2>
        </Collapse>

        <h3 style={{ margin: '0' }}>עדיין מתלבטים? שלחו הודעה בוואטסאפ</h3>
        <p style={{ margin: '0' }}>(לחצו על האייקון למטה)</p>
        <a href='/meow'>
          <img style={{ width: '50px' }} src='styles/images/whatsapp.png'></img>
        </a>
      </div>
    );
  }
